 ...
 * 
 */
@WebServiceClient(name = "ClienteServiceImplService", targetNamespace = "http://service.servicio.fpalacios.com.sv/", wsdlLocation = "http://localhost:1515/ws/clientes?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CLIENTESERVICEIMPLSERVICE_QNAME = new QName("http://service.servicio.fpalacios.com.sv/", "ClienteServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1515/ws/clientes?wsdl");
    ...
    public ClienteService getClienteServiceImplPort() {
        return super.getPort(new QName("http://service.servicio.fpalacios.com.sv/", "ClienteServiceImplPort"), ClienteService.class);
    }
    ...
    public ClienteService getClienteServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.servicio.fpalacios.com.sv/", "ClienteServiceImplPort"), ClienteService.class, features);
    }
